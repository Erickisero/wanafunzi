...
<head>
            ...
            <div class="navbar-nav mx-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="{{route('home.feature')}}" class="dropdown-item">Features</a>
                        <a href="{{route('home.team')}}" class="dropdown-item">The Team</a>
                        <a href="{{route('home.testimonials')}}" class="dropdown-item">Testimonials</a>
                    </div>
                </div>
            ...
            <div class="row gx-5">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">123 Tom mboya, Nairobi, Kenya</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-white me-2"></i>
                                <p class="text-white mb-0">info@farmfresh.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-white me-2"></i>
                                <p class="text-white mb-0">+254 745 67890</p>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-n5">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-secondary p-5">
                        ...
                        <p>this is one of the favourite websites</p>
                        <form action="">
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">FreshFarm</a>. All Rights Reserved. Designed by <a class="text-secondary fw-bold" href="https://htmlcodex.com">Spartans dev</a></p>
        </div>
    </div>
