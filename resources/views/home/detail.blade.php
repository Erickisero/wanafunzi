            ...
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    <div class="row g-5 mb-5">
                        <div class="col-md-6">
                            <img class="img-fluid w-100" src="{{asset('home_ui/img/blog-1.jpg')}}" alt="">
                        </div>
                        <div class="col-md-6">
                            <img class="img-fluid w-100" src="{{asset('home_ui/img/blog-2.jpg')}}" alt="">
                        </div>
                    </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex mb-4">
                        <img src="{{asset('home_ui/img/user.jpg')}}" class="img-fluid" style="width: 45px; height: 45px;">
                        <div class="ps-3">
